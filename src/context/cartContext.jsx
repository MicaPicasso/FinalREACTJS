...
export function CartProvider({children}){
    ...
    return(
        <CartContext.Provider value={{cart, setCart, onAddToCart, onDecreaseItem, onRemoveCartItem, total, products, categories, setProducts, setCategories, getItemQuantity}}>
            {children}
